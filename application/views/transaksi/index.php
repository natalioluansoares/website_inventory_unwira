    ...
    <div class="soares fs-2" data-flas="<?php echo $this->session->flashdata('error'); ?>">
        ...
        <main>
            <!-- <section class="advert section">
                <div class="advert-center container">
                    <div class="advert-box">
                        <a href="">
                            <img src="<?= base_url('assets_transaksi/');?>images/youtube.jpg" alt="">
                        </a>
                    </div>
                    <div class="advert-box">
                        <a href="">
                            <img src="<?= base_url('assets_transaksi/');?>images/instagram.jpg" alt="">
                        </a>
                    </div>
                    <div class="advert-box">
                        <a href="">
                            <img src="<?= base_url('assets_transaksi/');?>images/facebook.png" alt="" width="90px">
                        </a>
                    </div>
                </div>
            </section> -->
            ...
            <section class="section">
                <div class="title">
                    <h1>Misi Dan Visi Fakultas</h1>
                </div>
                <div class="testimonial-center container">
                    <div class="row">
                        <?php foreach ($operator_fakultas as $key => $value): ?>
                        <div class="col-lg-4">
                            <table>
                                <div class="testimonial">
                                    ...
                                    <div class="rating">
                                        <h5><?= date('d F Y', $value['created_akun']); ?></h5>
                                    </div>
                                    <div class="img-cover">
                                        <img src="<?= base_url() ?>assets/images/user/<?= $value['foto']; ?>" alt="" />
                                    </div>
                                    <h2><?php echo $value['nama_lengkap']; ?></h2>
                                    <h4><?php echo $value['nama_jurusan']; ?></h4>
                                </div>
                            </table>
                        </div>
                        <?php endforeach;?>
            ...
            <section class="section">
                <div class="title">
                    <h1>Misi Dan Visi Jurusan</h1>
                </div>

                <div class="testimonial-center container">
                    <div class="row">
                        <?php foreach ($operator_jurusan as $key => $value): ?>
                        <div class="col-lg-4">
                            <table>
                                <div class="testimonial">
                                    <span>&ldquo;</span>
