                            ...
                            <table class="table table-striped" id="datatable">
                                <thead class="table-primary">
                                    <tr>
                                        ...
                                        <th class="text-center"><a href="<?= base_url('admin/tambah_barang_rusak'); ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $br['pembayaran'] - ($br['harga_perbaiki'] * $br['jumlah_barang_rusak']); ?>
                                        </td>
                                        ...
                                        <td align="center">
                                            <a href="" class="btn btn-warning mb-2" title="Detail Operator"
                                                ...
                                                id="modaldetail" data-id="<?= $br['id_rusak']; ?>"
                                                data-nama="<?= $br['nama_lengkap']; ?>"
                                                data-level="<?= $br['nama_jurusan']; ?>"><i
                                                    class="ion-android-contacts"></i></a>

                                            <a href="<?= base_url('admin/edit_barang_rusak/' . $br['id_rusak']); ?>"
                                            ...
                                            <a href="<?= base_url('admin/deletebarangrusak/' . $br['id_rusak']); ?>"
...
<div class="modal fade stok" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/update_rusak'); ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="jumlah_harga">Harga Perbaiki</label>
                                <input type="text" class="form-control" id="hargaperbaiki" name="hargaperbaiki"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="jumlah_harga">Jumlah Harga Perbaiki</label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="bayaran" id="bayaran"
                                    placeholder="Pembayaran" min="0">
                            </div>
                            <?= form_error('pembayaran', '<small class="text-danger pl-2">', '</small>'); ?>
                        </div>
                    </div>
