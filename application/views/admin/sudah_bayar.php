<div class="wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class=" col-md-4">
                <a href="<?=base_url("admin/semua_sudah_transaksi"); ?>" id="cetaklaporansm"
            ...
            <div class="col-md-4">
                <div class="dropdown">
                    ...
                    <a href="<?= base_url('admin/sudah_bayar'); ?>" class="btn btn-danger text-white btn-block"><i
                            class=" fa fas fa-eye" title="Tampilkan semua"></i>
                        Tampilkan semua</a>
                    <?php } ?>
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('admin/sudah_bayar'); ?>" method='GET'>
            ...
            <div class="col-md-4">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('admin/sudah_transaksi') ?>" method='GET'>
                            <div class="form-group">
                                <label for="">start</label>
                                <input type="date" class="form-control" id="filter-tanggal-sm-awal" name="tanggal_awal">
                            </div>
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class="table-rep-plugin">
                                <div class="table-responsive nato" data-pattern="priority-columns">
