        ...
        <!-- <div class="row">
            <div class="col-md-12">
                <div class="dropdown">
                    ...
                    <a href="<?= base_url('admin/detailbarang_masuk'); ?>"
                    ...
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('admin/detailbarang_masuk'); ?>" method='GET'>
                            ...
                            <table class="table table-striped" id="datatable">
                                <thead class="table-primary">
                                    <tr>
                                        ...
                                        <th align="center">
                                            <a href="<?= base_url('admin/tambah_pinjaman'); ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" width="10%">
                                            <a href="" class="btn btn-warning form-control mb-2" title="Detail Data"
                                                data-toggle="modal" data-animation="bounce" data-target=".detail"
                                                id="modaldetail" data-pinjaman="<?= $bp['id_pinjaman'] ?>"
                                                ...
                                                data-jumlah="<?= $bp['jumlah_harga_pinjam'] ?>"><i class="
                                                    ion-android-contacts"></i>
                                            </a>


                                            <a href="<?= base_url('admin/edit_pinjaman/' . $bp['id_pinjaman']); ?>"
                                                class="btn btn-info form-control mb-2" title="Ubah Data"><i
                                                    class="fa fa-edit"></i></a>

                                            <a href="<?= base_url('admin/delete_pinjaman/' . $bp['id_pinjaman']); ?>"
                                                class="btn btn-danger form-control mb-2" id="delete" title="Hapus"><i
                                                    class="ion-android-trash "></i>
                                            </a>

                                            <a href="" data-toggle="modal" data-target=".ubah" id="modelkategori"
                                                data-id="<?= $bp['id_pinjaman'] ?>" data-status="<?= $bp['status'] ?>"
...
<div class="modal fade ubah" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/update_pembayaran'); ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
...
$(function() {
    $('body').on('keyup', '#pembayaran', function() {
        ...
        $('#sisa_pembayaran').val(-harga_barang_pinjam - total_pinjam);
...
<div class="modal fade stok" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/update_stok'); ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
...
$(document).ready(function(e) {
    $("#form").on("submit", (function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?= base_url('admin/update_stok'); ?>',
            type: 'POST',
            data: new FormatData(this),
            contentType: false,
            cache: false,
