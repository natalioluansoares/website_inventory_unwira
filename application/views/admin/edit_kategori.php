<div class="wrapper">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('admin/proses_kategori'); ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="idkategori" id="idkategori" placeholder="Kategori"
                                    class="form-control" value="<?= $kategori['id_kategori'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select name="user" id="operator" class="form-control">
                                    ...
                                    <option value="<?=$kategori['id_user'] ?>"><?=$kategori['nama_lengkap'] ?>
                                    </option>
                                </select>
                                <?= form_error('user', '<small class="text-danger pl-2">', '</small>'); ?>
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <a href="<?= base_url('admin/kategori'); ?>" class="btn btn-success"><i
