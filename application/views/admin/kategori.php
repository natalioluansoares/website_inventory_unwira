                                ...
                                <table class="table table-striped" id="datatable">
                                    <thead class="table-primary">
                                        <tr>
                                            ...
                                            <th>Operator</th>
                                            <th>Nama Operator</th>
                                            <th class="text-center"><a href="<?= base_url('admin/tambah_kategori')?>"
                                    ...
                                    foreach ($kategori as $kt) : ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?=base_url('admin/edit_kategori/'.$kt['id_kategori'])?>"
                                                    class="btn btn-info btn-animation mb-2" title="Ubah Data">
                                                    <i class="fa fa-edit"></i></a>
                                                <a href="<?= base_url('admin/delete_kategori/' . $kt['id_kategori']); ?>"
