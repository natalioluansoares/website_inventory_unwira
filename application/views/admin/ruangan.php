                                ...
                                <table class="table table-striped" id="datatable">
                                    <thead class="table-primary">
                                        <tr>
                                            ...
                                            <th>Operator</th>
                                            <th>Nama Operator</th>
                                            <th><a href="<?= base_url('admin/tambah_ruangan')?>"
                                    ...
                                    foreach ($ruangan as $rg) : ?>
                                        <tr>
                                            ...
                                            <td><?= $rg['nama_jurusan']; ?></td>
                                            <td><?= $rg['nama_lengkap']; ?></td>
                                            <td align="center">
                                                ...
                                                <a href="<?= base_url('admin/edit_ruangan/'.$rg['id_ruangan'])?>"
                                                    class="btn btn-info btn-animation mb-2" title="Ubah Data"><i
                                                        class="fa fa-edit"></i></a>

                                                <a href="<?= base_url('admin/delete_ruangan/' . $rg['id_ruangan']); ?>"
