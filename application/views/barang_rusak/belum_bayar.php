<div class="wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class=" col-md-3">
                <a href="<?=base_url("barang_rusak/semua_barang_rusak_belum_bayar"); ?>" id="cetaklaporansm"
            ...
            <div class="col-md-2">
                <div class="dropdown">
                    ...
                    <a href="<?= base_url('barang_rusak/filter_belum_bayar'); ?>"
                    ...
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('barang_rusak/filter_belum_bayar'); ?>" method='GET'>
            ...
            <div class="col-md-2">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('barang_rusak/laporan_filter_belum_bayar') ?>" method='GET'>
                            <div class="form-group">
                                <label for="">start</label>
                                <input type="date" class="form-control" id="filter-tanggal-sm-awal" name="tanggal_awal">
                            </div>
