<div class="wrapper">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('uang_kas_fakultas/proses_edit'); ?>" method="POST">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="fakultas" id="uang_fakultas" class="form-control">
                                    <option value="<?= $uang_kas_fakultas['nama_fakultas'];?>">
                                        <?= $uang_kas_fakultas['nama_fakultas'];?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="jurusan" id="uang_jurusan" class="form-control">
                                    <option value="<?= $uang_kas_fakultas['nama_jurusan'];?>">
                                        <?= $uang_kas_fakultas['nama_jurusan'];?></option>
                                </select>
                                <?= form_error('jurusan', '<small class="text-danger pl-2">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="id"
                                    value="<?= $uang_kas_fakultas['id_uang_kas_fakultas_jurusan'];?>">
                                <label>Operator</label>
                                <select name="user" id="uang_operator" class="form-control">
                                    <option value="<?= $uang_kas_fakultas['id_user'];?>">
                                        <?= $uang_kas_fakultas['nama_lengkap'];?></option>
                                </select>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <a href="<?= base_url('uang_kas_fakultas'); ?>" class="btn btn-success"><i
