                                    ...
                                    <thead class="table-primary">
                                        <tr>
                                            ...
                                            <th class="text-center"><a
                                                    href="<?= base_url('operator_fakultas/tambah_kategori')?>"
                                                    class="btn btn-warning btn-animation mb-2 form-control"
                                                    title="Tambah Data"><i class="fa fa-user-plus"></i></a></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $no = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="" class="btn btn-warning mb-2" title="Detail Operator"
                                                    ...
                                                    id="modaldetail" data-id="<?= $kt['id_kategori']; ?>"
                                                    data-nama="<?= $kt['nama_lengkap']; ?>"
                                                    data-level="<?= $kt['nama_jurusan']; ?>"><i
                                                        class="ion-android-contacts"></i></a>

                                                <a href="<?=base_url('operator_fakultas/edit_kategori/'.$kt['id_kategori'])?>"
                                                    class="btn btn-info btn-animation mb-2" title="Ubah Data">
                                                    <i class="fa fa-edit"></i></a>
                                                <a href="<?= base_url('operator_fakultas/delete_kategori/' . $kt['id_kategori']); ?>"
