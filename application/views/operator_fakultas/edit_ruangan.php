<div class="wrapper">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('operator_fakultas/proses_ruangan'); ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <a href="<?= base_url('operator_fakultas/ruangan'); ?>" class="btn btn-success"><i
