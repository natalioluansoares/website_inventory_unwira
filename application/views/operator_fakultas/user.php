                            ...
                            <table class="table table-striped" id="datatable">
                                <thead class="table-primary">
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 20%;"><a
                                                href="<?= base_url('operator_fakultas/tambah_operator'); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="width:300px;">
                                            <a href="" class="btn btn-warning mb-2" title="Detail Operator"
                                                ...
                                                data-nama="<?= $u['nama_lengkap']; ?>" data-level="<?= $u['level']; ?>"
                                                data-depan="<?= $u['nama_depan']; ?>"
                                                data-belakang="<?= $u['nama_belakang']; ?>"><i
                                                    class="ion-android-contacts"></i></a>

                                            <a href="<?= base_url('operator_fakultas/edit_operator/' . $u['id_user']); ?>"
                                                class="btn btn-info mb-2" title="Ubah Data"><i
                                                    class="fa fa-edit"></i></a>

                                            <a href="<?= base_url('operator_fakultas/deleteuser/' . $u['id_user']); ?>"
                                                    ...
                                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                                        ...
                                                        <p class="notify-details">
                                                            <b><?= $value['nama_lengkap'] ?></b><small
                                                                class="text-muted"><?= $value['nama_jurusan'] ?></small>
                                                        </p>
                                                    </a>
                                                    <?php endforeach;?>
                                                    <!-- All-->
                                            ...
                                            <a href="<?= base_url('operator_fakultas/toggle_operator_jurusan/') . $u['id_user'] ?>"
...
<div class="modal fade user" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('operator_fakultas/changepassword'); ?>" method="POST"
