        ...
        <div class="row">
            <div class="col-md-2">
                <div class="dropdown">
                    ...
                    <a href="<?= base_url('operator_teknik/detailbarang_masuk'); ?>"
                    ...
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('operator_teknik/detailbarang_masuk'); ?>" method='GET'>
                                    ...
                                    <table class="table table-striped" id="datatable">
                                        <thead class="table-primary">
                                            <tr>
                                                ...
                                                <!-- <th>Nama Pinjaman</th> -->
                                                <th>
                                                    <a href="<?= base_url('operator_fakultas/tambah_pinjaman'); ?>"
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" width="10%">
                                                    <a href="" class="btn btn-warning form-control mb-2"
                                                        ...
                                                        data-jumlah="<?= $bp['jumlah_harga_pinjam'] ?>">
                                                        <i class="ion-android-contacts"></i></a>


                                                    <a href="<?= base_url('operator_fakultas/edit_pinjaman/' . $bp['id_pinjaman']); ?>"
                                                        class="btn btn-info form-control mb-2" title="Ubah Data"><i
                                                            class="fa fa-edit"></i></a>

                                                    <a href="<?= base_url('operator_fakultas/delete_pinjaman/' . $bp['id_pinjaman']); ?>"
                                                        class="btn btn-danger form-control mb-2" id="delete"
                                                        title="Hapus"><i class="ion-android-trash "></i></a>
                                                    ...
                                                    <a href="" data-toggle="modal" data-target=".ubah"
                                                        ...
                                                        title="Data Pembayaran"><i class="fa fa-paypal "></i></a>
                                                    ...
                                                    <a href="" data-toggle="modal" data-target=".stok" id="modelupdate"
                                                        ...
                                                        title="Data Pembayaran"><i class="fa fa-briefcase "></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
...
<div class="modal fade ubah" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('operator_fakultas/update_pembayaran'); ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
...
$(document).ready(function(e) {
    $("#form").on("submit", (function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?= base_url('operator_fakultas/update_pembayaran'); ?>',
            type: 'POST',
            ...
            success: function() {
                document.location.href =
                    "<?= base_url('operator_fakultas/pinjaman'); ?>";
            }
        });
    }));
})
...
<div class="modal fade stok" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('operator_fakultas/update_stok'); ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group" align="center">
...
$(document).ready(function(e) {
    $("#form").on("submit", (function(e) {
        e.preventDefault();
        $.ajax({
            url: '<?= base_url('operator_fakultas/update_stok'); ?>',
            type: 'POST',
            data: new FormatData(this),
            contentType: false,
            cache: false,
