                                ...
                                <thead class="table-primary">
                                    <tr>
                                        ...
                                        <th class="text-center"><a
                                                href="<?= base_url('operator_fakultas/tambah_barang_rusak'); ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="<?= base_url('operator_fakultas/edit_barang_rusak/' . $br['id_rusak']); ?>"
                                            ...
                                            <a href="<?= base_url('operator_fakultas/deletebarangrusak/' . $br['id_rusak']); ?>"
...
<div class="modal fade stok" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('operator_fakultas/update_rusak'); ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
