<div class="wrapper">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('operator_fakultas/prosesbarangpinjaman'); ?>" method="POST">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select id="stok_baranghukum" class="form-control" name="stok_barang">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="number" class="form-control" placeholder="Total Pinjaman"
                                        id="totalpinjaman" name="totalpinjaman" value="1" min="1">
                                </div>
