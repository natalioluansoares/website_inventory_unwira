                                    ...
                                    <thead class="table-primary">
                                        <tr>
                                            ...
                                            <th class="text-center"><a
                                                    href="<?= base_url('operator_fakultas/tambah_barang'); ?>"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?= base_url('operator_fakultas/edit_barang/' . $br['id_barang']); ?>"
                                                    class="btn btn-info mb-2" title="Ubah Data"><i
                                                        class="fa fa-edit"></i></a>
                                                <a href="<?= base_url('operator_fakultas/deletebarang/' . $br['id_barang']); ?>"
