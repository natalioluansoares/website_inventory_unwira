<div class="wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class=" col-md-4">
                <a href="<?=base_url("operator_fakultas/semua_transaksi_masih_panjar"); ?>" id="cetaklaporansm"
            ...
            <div class="col-md-4">
                <div class="dropdown">
                    ...
                    <a href="<?= base_url('operator_fakultas/transaksi_panjar'); ?>"
                    ...
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('operator_fakultas/transaksi_panjar'); ?>" method='GET'>
            ...
            <div class="col-md-4">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('operator_fakultas/transaksi_masih_panjar') ?>" method='GET'>
                            <div class="form-group">
                                <label for="">start</label>
                                <input type="date" class="form-control" id="filter-tanggal-sm-awal" name="tanggal_awal">
                            </div>
