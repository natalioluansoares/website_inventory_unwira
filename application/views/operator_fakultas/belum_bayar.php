<div class="wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class=" col-md-4">
                <a href="<?=base_url("operator_fakultas/semua_belum_transaksi"); ?>" id="cetaklaporansm"
            ...
            <div class="col-md-4">
                <div class="dropdown">
                    ...
                    <a href="<?= base_url('operator_fakultas/belum_bayar'); ?>"
                    ...
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('operator_fakultas/belum_bayar'); ?>" method='GET'>
            ...
            <div class="col-md-4">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu lg" aria-labelledby="dropdownMenuButton">
                        <form action="<?= base_url('operator_fakultas/belum_transaksi') ?>" method='GET'>
                            <div class="form-group">
                                <label for="">start</label>
                                <input type="date" class="form-control" id="filter-tanggal-sm-awal" name="tanggal_awal">
                            </div>
