                            ...
                            <table class="table table-striped" id="datatable">
                                <thead class="table-primary">
                                    <tr>
                                        ...
                                        <th class="text-center"><a href="<?= base_url('user/tambah'); ?>"
                                                class="btn btn-primary mb-2" title="Tambah Data"><i
                                                    class="fa fa-plus"></i></a>
                                            <div class="btn-group m-b-10">
                                                <button type="button"
                                                    class="btn btn-primary form-control dropdown-toggle"
                                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                    title="Pilih Operator Fakultas Dan Jurusan"></button>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                        href="<?= base_url('user/operator_fakultas'); ?>">Operator
                                                        Fakultas</a>
                                                    <a class="dropdown-item"
                                                        href="<?= base_url('user/operator_jurusan'); ?>">Operator
                                                        Jurusan</a>
                                                </div>
                                            </div>
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="width:300px;">
                                            ...
                                            <a href="<?= base_url('user/deleteuser/' . $u['id_user']); ?>"
                                                class="btn btn-danger mb-2" id="delete" title="Hapus Data"><i
