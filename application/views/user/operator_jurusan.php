                            ...
                            <table class="table table-striped" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $u['level']; ?></td>
                                        <td align="center">
                                            <img src="<?= base_url() ?>assets/images/user/<?= $u['foto']; ?>"
                                                style="width:80px ;" class="img-thumbnail rounded-circle">
                                        </td>
                                        <td align="center" style="width:300px;">
                                            ...
                                            <a href="<?= base_url('user/toggle_operator_jurusan/') . $u['id_user'] ?>"
