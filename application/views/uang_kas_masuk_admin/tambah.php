<div class="wrapper">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('uang_kas_admin/tambah_uang_kas_masuk'); ?>" method="POST">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="user" id="uang_operator" class="form-control">
                                    ...
                                    <option value="<?= $value['id_uang_kas_unwira']?>"><?= $value['nama_lengkap']?>
                                    </option>
                                    <?php endforeach;?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="jumlah_uang_masuk"
                                    placeholder="Jumlah Uang Masuk">
                                <?= form_error('jumlah_uang_masuk', '<small class="text-danger pl-2">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <div>
                                    ...
                                    <a href="<?= base_url('uang_kas_admin'); ?>" class="btn btn-success"><i
