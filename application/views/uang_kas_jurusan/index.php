                            ...
                            <table class="table table-striped" id="datatable">
                                <thead class="table-primary">
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <a href="<?=base_url('uang_kas_jurusan/tambah') ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="<?=base_url('uang_kas_jurusan/edit/'.$kt['id_uang_kas_fakultas_jurusan']) ?>"
                                                class="btn btn-info btn-animation mb-2">
                                                <i class="fa fa-edit"></i></a>
                                            <a href="<?= base_url('uang_kas_jurusan/hapus/' . $kt['id_uang_kas_fakultas_jurusan']); ?>"
