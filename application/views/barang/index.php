                                ...
                                <table class="table table-striped" id="datatable">
                                    <thead class="table-primary">
                                        <tr>
                                            ...
                                            <th class="text-center"><a href="<?= base_url('barang/tambah'); ?>"
                                    ...
                                    foreach ($barang as $br) : ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?= base_url('barang/edit/' . $br['id_barang']); ?>"
                                                    class="btn btn-info mb-2" title="Ubah Data"><i
                                                        class="fa fa-edit"></i></a>

                                                <a href="<?= base_url('barang/deletebarang/' . $br['id_barang']); ?>"
                                                    class="btn btn-danger mb-2" title="Hapus Data"><i
