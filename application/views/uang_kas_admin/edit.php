<div class="wrapper">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('uang_kas_admin/proses_edit'); ?>" method="POST">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="id"
                                    value="<?= $uang_kas_admin['id_uang_kas_unwira']?>">
                                <select name="user" id="uang_operator" class="form-control">
                                    <option value="<?= $uang_kas_admin['operator_unwira']?>">
                                        <?= $uang_kas_admin['nama_lengkap']?></option>
