<div class="wrapper">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('uang_kas_fakultas/tambah_uang_transaksi_barang'); ?>" method="POST">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="nama_perbaiki" id="transaksi_barang" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select id="total_transaksi" name="pembayaran" class="form-control">
