<div class="wrapper">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('uang_kas_jurusan/tambah_uang_transaksi_barang'); ?>" method="POST">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="nama_perbaiki" id="transaksi" class="form-control">
                                            <option value="">Nama Barang</option>
                                            <?php foreach ($barang as $key => $value): ?>
                                            <option value="<?=$value['id_barang'] ?>"><?=$value['nama_barang'] ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Jumlah Harga Pembayaran</label>
                                        <select id="totaltransaksi" name="pembayaran" class="form-control">
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <a href="<?= base_url('uang_kas_jurusan/uang_kas_keluar'); ?>"
